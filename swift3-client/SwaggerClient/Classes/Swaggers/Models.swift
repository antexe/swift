...
class Decoders {
    ...
    private static var __once: () = {
        ...
        Decoders.addDecoder(clazz: InlineResponse200.self) { (source: AnyObject) -> InlineResponse200 in
            ...
            instance.lat = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lat"] as AnyObject?)
            instance.lon = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["lon"] as AnyObject?)
            return instance
        }
